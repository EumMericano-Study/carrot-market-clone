      ...
      <div className="mb-8">
        ...
        <div className="mt-5">
          ...
          <p className="text-gray-700 my-6">
            This is new generation phone! Lorem ipsum dolor sit amet consectetur
            adipisicing elit. Officiis est labore corrupti laudantium! Corrupti,
            quos corporis? Amet labore deleniti dolorem expedita odit ut non
            saepe distinctio aperiam, inventore, ipsa eius corrupti maxime. Amet
            maxime obcaecati soluta corporis ab dolor aperiam eaque! Atque vel,
            maxime quae assumenda saepe repudiandae error dolorem!
          </p>
